      ...
      <div class="max-w-6x1">
        <div class="flex justify-between">
          ...
          <div>
            <a
              href="/"
              class="flex items-center py-4 px-2 text-gray-700 no-underline"
            >
              <!--Onde eu coloco a cor dos links -->
              <svg
              ...
              <span class="font-bold text-gray-100 hover:text-gray-400 text-lg"
                >SolinfBroker</span
              >
            </a>
          </div>
          ...
          <div class="flex items-center space-x-1 mr-9">
            <a
              href="/"
              class="py-5 px-3 text-gray-100 hover:text-gray-400 no-underline"
              v-if="authenticated"
              >Dashboard</a
            >
            <a
